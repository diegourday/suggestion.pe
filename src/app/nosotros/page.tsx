...
const values = [
  {
    ...
    description:
      "Nos apasiona ver crecer a nuestros clientes. Cada éxito es nuestro éxito, y trabajamos incansablemente para lograrlo.",
  },
  {
    icon: Lightbulb,
    title: "Innovación Constante",
    description:
      "El marketing digital evoluciona cada día. Nos mantenemos a la vanguardia de tendencias y tecnologías.",
  },
  {
    icon: Shield,
    title: "Transparencia Total",
    description:
      "Sin humo ni promesas vacías. Reportes claros, métricas reales y comunicación constante.",
  },
  {
    icon: Users,
    title: "Enfoque Human-Centered",
    description:
      "Conectamos marcas con personas. Cada estrategia está diseñada para generar conexiones emocionales reales.",
  },
  {
    icon: Target,
    title: "Resultados Medibles",
    description:
      "Cada acción tiene un KPI, cada campaña tiene un ROI. Transparencia total en tu inversión.",
  },
  {
    icon: Zap,
    title: "Metodología Ágil",
    description:
      "Iteramos rápido, aprendemos más rápido. Adaptación constante para maximizar resultados.",
  },
];
...
const team = [
  {
    ...
    role: "CEO & Founder",
    description:
      "15+ años de experiencia en marketing digital. Anteriormente lideró equipos en empresas Fortune 500.",
    image: null,
    initials: "MG",
  },
  {
    ...
    description:
      "Especialista en growth marketing y optimización de conversiones. Certificado en Google y Meta.",
    image: null,
    initials: "CR",
  },
  {
    ...
    description:
      "Diseñadora y creativa premiada. Experta en branding y comunicación visual.",
    image: null,
    initials: "AM",
  },
  {
    ...
    description:
      "Desarrollador full-stack con enfoque en performance y UX. Líder técnico del equipo.",
    image: null,
    initials: "RS",
  },
];
...
const milestones = [
  {
    year: "2015",
    title: "Fundación",
    description: "Nacimos con la misión de transformar el marketing digital.",
  },
  {
    year: "2017",
    title: "Primeros 50 Clientes",
    description: "Alcanzamos nuestra primera meta significativa de clientes.",
  },
  {
    year: "2019",
    title: "Expansión Regional",
    description: "Abrimos oficinas en 3 países de Latinoamérica.",
  },
  {
    year: "2021",
    title: "Certificación Google Partner",
    description: "Reconocidos como partners certificados de Google.",
  },
  {
    year: "2023",
    title: "150+ Clientes Activos",
    description: "Crecimiento sostenido con alta tasa de retención.",
  },
  {
    year: "2025",
    title: "Innovación en IA",
    description: "Integramos inteligencia artificial en nuestros procesos.",
  },
];
...
const infoCards = [
  {
    ...
    description:
      "Transformar la presencia digital de nuestros clientes en resultados medibles y sostenibles, mediante estrategias personalizadas que combinan creatividad, tecnología y datos.",
    color: "#FF6600",
  },
  {
    icon: Eye,
    ...
    description:
      "Ser la agencia de marketing digital de referencia en Latinoamérica, reconocida por nuestra capacidad de innovar y generar resultados excepcionales.",
    color: "#00BFFF",
  },
  {
    icon: Rocket,
    ...
    description:
      "Construir relaciones a largo plazo con nuestros clientes basadas en confianza, transparencia y éxito mutuo en cada proyecto.",
    color: "#FF6600",
  },
];
...
export default function NosotrosPage() {
  ...
  return (
    <main className="min-h-screen pt-16">
      ...
      <section
        ref={heroRef}
        className="relative py-16 sm:py-20 md:py-28 overflow-hidden bg-black"
      >
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              Somos una agencia de marketing digital apasionada por crear
              estrategias que generan resultados reales y sostenibles para
              nuestros clientes.
            </motion.p>
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-8 relative z-10 text-center">
          ...
          >
            ...
            <p
              ...
              style={{ fontFamily: "var(--font-inter)" }}
            >
              Agenda una llamada y descubre cómo podemos ayudarte a alcanzar tus
              objetivos.
            </p>
