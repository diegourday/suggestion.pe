...
const serviciosPrincipales = [
  {
    ...
    icon: TrendingUp,
    description: "Estrategias integrales que transforman",
  },
  {
    name: "Redes Sociales",
    href: "/servicios/marketing-redes-sociales",
    icon: Share2,
    description: "Conexión auténtica con tu audiencia",
  },
  {
    name: "Publicidad Digital",
    href: "/servicios/publicidad-digital",
    icon: Target,
    description: "Campañas con ROI medible",
  },
  {
    name: "SEO",
    href: "/servicios/seo-posicionamiento",
    icon: Search,
    description: "Posicionamiento orgánico efectivo",
  },
  {
    name: "Branding",
    href: "/servicios/branding-diseno",
    icon: Palette,
    description: "Identidad que deja huella",
  },
  {
    name: "Desarrollo Web",
    href: "/servicios/desarrollo-web",
    icon: Code,
    description: "Sitios que convierten visitantes",
  },
  {
    name: "Consultoría",
  ...
  },
  {
    ...
    icon: Zap,
    description: "Automatiza y escala tu negocio",
  },
  {
    name: "Producción Audiovisual",
    href: "/servicios/produccion-audiovisual",
    icon: Video,
    description: "Contenido visual de impacto",
  },
  {
    name: "Investigación de Mercado",
    href: "/servicios/investigacion-mercado",
    icon: BarChart3,
    description: "Datos que guían decisiones",
  },
];
...
const serviciosComplementarios = [
  ...
  },
  {
    ...
    href: "/servicios/imprenta-corporativa",
    icon: Printer,
  },
  {
          ...
          <div className="flex items-center justify-between h-14 sm:h-16">
            ...
            <Link href="/" className="flex items-center flex-shrink-0">
              <img
                src="/logo-negro.png"
                alt="Suggestion Logo"
                className="h-5 sm:h-5 w-auto mix-blend-multiply"
              />
            </Link>
                        ...
                        >
                          <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 p-4 sm:p-6 w-[90vw] max-w-[800px]">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8">
                                    ...
                                    .map((service) => (
                                      ...
                                      >
                                        ...
                                        <div className="min-w-0">
                                          <div
                                            className="text-sm font-medium text-gray-800 group-hover:text-black truncate"
                                            style={{
                                              fontFamily:
                                                "var(--font-montserrat)",
                                            }}
                              ...
                              <div>
                                <h3
                                  className="text-xs font-bold uppercase tracking-wider text-gray-400 mb-3 hidden sm:block"
                                  style={{
                                    fontFamily: "var(--font-montserrat)",
                                  }}
                                >
                              ...
                              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                                {serviciosComplementarios.map((service) => (
                                  ...
                                  >
                                    ...
                                    <span
                                      className="text-xs sm:text-sm font-medium text-gray-700 group-hover:text-black truncate"
                                      style={{
                                        fontFamily: "var(--font-montserrat)",
                                      }}
                                    >
