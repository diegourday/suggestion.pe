...
const footerLinks = {
  servicios: [
    { name: "CRM y Automatización", href: "/servicios/crm-automatizacion" },
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(0, 191, 255, 0.03) 0%, transparent 60%)",
          }}
          animate={{
            scale: [1.2, 1, 1.2],
            opacity: [0.3, 0.5, 0.3],
      ...
      <div
        className="container mx-auto px-6 sm:px-8 lg:px-8 relative z-10"
        ref={ref}
      >
        {/* Main Footer Content */}
        <motion.div
        ...
        >
          ...
          >
            ...
            <p className="text-gray-400 mb-4 sm:mb-6 max-w-sm text-sm sm:text-base leading-relaxed">
              Agencia de marketing digital que transforma tu presencia en
              resultados. Consigue lo posible haciendo lo imposible.
            </p>
            ...
            <ul className="space-y-2 sm:space-y-3">
              {footerLinks.servicios.map((link, index) => (
                ...
                >
                  ...
                  >
                    <motion.span className="w-0 h-0.5 bg-[#00BFFF] group-hover:w-2 transition-all duration-300" />
                    {link.name}
                  </Link>
                </motion.li>
              ))}
          ...
          >
            ...
            <ul className="space-y-3 sm:space-y-4">
              ...
              >
                ...
                <span className="break-all">hablemos@suggestion.pe</span>
              </motion.li>
              <motion.li
              ...
              >
                ...
                <span>Residencial Jardin C4, Urb San jose</span>
              </motion.li>
            </ul>
          </motion.div>
        </motion.div>
        ...
        >
          <p className="text-gray-500 text-xs sm:text-sm text-center sm:text-left order-2 sm:order-1">
            © {new Date().getFullYear()} Suggestion. Todos los derechos
            reservados.
          </p>
