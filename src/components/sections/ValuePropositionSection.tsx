...
const values = [
  {
    ...
    description:
      "Conectamos marcas con personas, no solo con métricas. Cada estrategia está diseñada para generar conexiones emocionales reales.",
  },
  {
    icon: TrendingUp,
    title: "Resultados Medibles",
    description:
      "No vendemos humo. Cada acción tiene un KPI, cada campaña tiene un ROI. Transparencia total en tu inversión.",
  },
  {
    icon: Shield,
    title: "Compromiso Total",
    description:
      "Tu éxito es nuestro éxito. Trabajamos como extensión de tu equipo, no como proveedores externos.",
  },
  {
    icon: Zap,
    title: "Metodología Ágil",
    description:
      "Iteramos rápido, aprendemos más rápido. Adaptación constante para maximizar resultados en tiempo real.",
  },
];
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle at 30% 50%, rgba(255, 102, 0, 0.05) 0%, transparent 50%)",
          }}
          animate={{
            opacity: [0.5, 1, 0.5],
          }}
      ...
      >
        ...
        >
          ...
          >
            Diferentes por <span className="text-gradient">decisión</span>
          </motion.h2>
          <motion.p
        ...
        <motion.div
          className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-10 sm:mb-12 md:mb-16"
          ...
          {values.map((value, index) => (
            <motion.div key={index} variants={itemVariants} className="h-full">
              <motion.div
                ...
                className="h-full"
              >
                <Card className="group h-full bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-500 overflow-hidden backdrop-blur-sm py-0">
                  <CardContent className="p-5 sm:p-6 md:p-8 h-full flex">
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-start w-full">
                      ...
                      <div className="flex-1 text-center sm:text-left flex flex-col justify-center">
                        <h3
                          className="text-lg sm:text-xl font-bold text-white mb-2 sm:mb-3 group-hover:text-gray-100 transition-colors pr-2"
                          style={{ fontFamily: "var(--font-montserrat)" }}
                        >
                          {value.title}
                        </h3>
        ...
        >
          ...
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(45deg, transparent, rgba(255, 102, 0, 0.08), transparent)",
            }}
            animate={{
              x: ["-100%", "100%"],
            }}
