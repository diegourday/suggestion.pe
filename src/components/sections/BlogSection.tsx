...
const posts = [
  {
    ...
    excerpt:
      "Descubre las estrategias que marcarán el rumbo del marketing digital este año.",
    category: "Tendencias",
    date: "15 Mar 2026",
    readTime: "8 min",
    color: "#FF6600",
  },
  {
    ...
    excerpt:
      "Guía completa para posicionar tu sitio web en los primeros resultados de búsqueda.",
    category: "SEO",
    date: "10 Mar 2026",
    readTime: "12 min",
    color: "#00BFFF",
  },
  {
    ...
    excerpt:
      "Aprende a conectar con tu audiencia a través de historias que generan engagement.",
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(0, 191, 255, 0.05) 0%, transparent 60%)",
          }}
          animate={{
            scale: [1, 1.2, 1],
            x: [0, 50, 0],
      ...
      >
        ...
        >
          <div className="max-w-2xl mb-4 sm:mb-0">
            ...
            >
              Ideas que <span className="text-gradient">inspiran</span>
            </motion.h2>
          </div>
          <motion.div
        ...
        >
          {posts.map((post, index) => (
            <motion.div key={index} variants={cardVariants}>
              ...
              >
                <Card className="group bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-500 cursor-pointer overflow-hidden backdrop-blur-sm py-0">
