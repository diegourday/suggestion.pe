...
const steps = [
  {
    ...
    description:
      "Analizamos tu negocio, competencia y mercado. Identificamos oportunidades y definimos objetivos claros.",
    color: "#FF6600",
  },
  {
    number: "02",
    ...
    title: "Estrategia",
    description:
      "Diseñamos un plan personalizado con tácticas específicas y KPIs claros.",
    color: "#00BFFF",
  },
  {
    number: "03",
  ...
  },
  {
    ...
    title: "Optimización",
    description:
      "Medimos, analizamos y mejoramos continuamente para maximizar resultados.",
    color: "#00BFFF",
  },
];
        ...
        >
          ...
          <div className="space-y-4 sm:space-y-6 lg:space-y-0 lg:grid lg:grid-cols-4 lg:gap-6 xl:gap-8 relative z-10">
            {steps.map((step, index) => (
              <motion.div key={index} variants={stepVariants} custom={index}>
                <motion.div
